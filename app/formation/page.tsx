        ...
        <div className="hidden md:flex md:flex-col md:gap-6 md:max-w-[800px] md:mx-auto">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="aspect-[1/2]">
              <BentoSlot id="d-4" className="h-full w-full" src="/images/Add a heading-6.png" isDesktop={true} />
            </div>
          ...
          <div className="aspect-[16/8] w-full">
            <BentoSlot id="d-7" className="h-full w-full" src="/images/DJYN.png" isDesktop={true} />
          </div>
